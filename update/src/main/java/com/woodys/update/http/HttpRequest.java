...
public class HttpRequest {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case downloadFailure:
                    downloadCallback.onDownloadFailure((String) msg.obj,-1);
                    break;
            }
        }
    };
     ...
     * @param callback 请求回调
     */
    public static void post(final String urlPath, final Map<String, String> params, CheckUpdateCallback callback) {
